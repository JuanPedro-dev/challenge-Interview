...
export class UserService {
  ...
  public addUser(user: User): Observable<User> {
    return this.http
      .post<User>(`${this.apiServerUrl}/${this.entity}`, user)
  ...
  public getUserById(id: string): Observable<User> {
    return this.http
      .get<User>(`${this.apiServerUrl}/${this.entity}/${id}`)
  ...
  public getUsers(): Observable<User[]> {
    return this.http
      .get<User[]>(`${this.apiServerUrl}/${this.entity}`)
  ...
  public updateUser(user: User): Observable<User> {
    return this.http
      .put<User>(`${this.apiServerUrl}/${this.entity}/${user.id}`, user)
  ...
  public deleteUser(userId: string): Observable<void> {
    return this.http
      .delete<void>(`${this.apiServerUrl}/${this.entity}/${userId}`)
